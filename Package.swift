...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/eu-digital-identity-wallet/eudi-lib-ios-iso18013-data-transfer.git", from: "0.15.0"),
		.package(url: "https://github.com/eu-digital-identity-wallet/eudi-lib-ios-wallet-storage.git", from: "0.11.3"),
